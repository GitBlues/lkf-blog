...
using WoBlog.Utility.Exceptions;
using WoBlog.Utility.Extensions;
using WoBlog.Utility.Properties;


namespace WoBlog.Utility.Filter
{
    /// <summary>
    /// 查询表达式辅助操作类
    /// </summary>
    public static class FilterHelper
    {
        ...
        private static Expression GetExpressionBody(ParameterExpression param, FilterGroup group)
        {
            ...
            throw new WoBlogException(Resources.Filter_GroupOperateError);
        }
        ...
        private static LambdaExpression GetPropertyLambdaExpression(ParameterExpression param, FilterRule rule)
        {
            ...
            foreach (string propertyName in propertyNames)
            {
                ...
                if (property == null)
                {
                    throw new WoBlogException(string.Format(Resources.Filter_RuleFieldInTypeNotFound, rule.Field, type.FullName));
                }
