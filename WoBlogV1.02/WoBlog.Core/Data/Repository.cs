...
using WoBlog.Core.Data.Extensions;
using WoBlog.Entities.Extensions;
using WoBlog.Entities.Models;
using WoBlog.Utility.Data;
using WoBlog.Utility.Extensions;

namespace WoBlog.Core.Data
{
    /// <summary>
    ...
    public class Repository<TEntity, TKey> : IRepository<TEntity, TKey> where TEntity : EntityBase<TKey>
    {
        ...
        public Repository(IUnitOfWork unitOfWork)
        {
            ...
            _dbSet = new WoBlogDBContext().Set<TEntity>(); //((DbContext)unitOfWork).Set<TEntity>();
        }
        ...
        OperationResult IRepository<TEntity, TKey>.Insert<TAddDto>(ICollection<TAddDto> dtos, Action<TAddDto> checkAction, Func<TAddDto, TEntity, TEntity> updateFunc)
        {
            return Insert(dtos, checkAction, updateFunc);
        }
        ...
        OperationResult IRepository<TEntity, TKey>.Delete(ICollection<TKey> ids, Action<TEntity> checkAction, Func<TEntity, TEntity> deleteFunc)
        {
            return Delete(ids, checkAction, deleteFunc);
        }
        ...
        OperationResult IRepository<TEntity, TKey>.Update<TEditDto>(ICollection<TEditDto> dtos, Action<TEditDto> checkAction, Func<TEditDto, TEntity, TEntity> updateFunc)
        {
            return Update(dtos, checkAction, updateFunc);
        }
